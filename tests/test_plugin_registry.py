...
class RegistryTests(unittest.TestCase):
    def test_auto_discovery_finds_all_default_plugins(self):
        self.assertEqual(
            ...
            {
                "weather", "quote", "quotable", "stoic", "dad_joke", "word_of_day", "bible_verse", "headlines", "hackernews", "reddit", "papers_with_code", "semantic_scholar", "github_trending", "product_hunt", "lobsters", "devto", "arxiv", "openalex", "air_quality",
